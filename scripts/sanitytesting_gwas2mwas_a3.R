...
summary_stats_list <- summary_stats_list[grepl("alleleprocessed", summary_stats_list)]
...
paths <- list(pvar_path = "/Users/michael.nagle/data/gwas_flipped/ref_EUR_allele-match-libd_chr7.pvar",
              pgen_path = "/Users/michael.nagle/data/gwas_flipped/ref_EUR_allele-match-libd_chr7.pgen",
              psam_path = "/Users/michael.nagle/data/gwas_flipped/ref_EUR_allele-match-libd_chr7.psam")
